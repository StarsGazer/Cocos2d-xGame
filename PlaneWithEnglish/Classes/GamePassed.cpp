...
Scene* GamePassed::createScene()
{
	// 'scene' is an autorelease object
	auto scene = Scene::create();

	// 'layer' is an autorelease object
	auto layer = GamePassed::create();
...
bool GamePassed::init()
{
	...
	**/
	...
	auto StartMenu = MenuItemLabel::create(Label::createWithBMFont("futura-48.fnt", "Press here to continue"), CC_CALLBACK_1(GamePassed::GameOn, this));
